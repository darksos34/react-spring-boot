...
Moving forward, we will use this repository as starting point of any further repositories which we will post here on GitHub.<br />
<br /><br />
### What is React?
React is an open-source JavaScript library that is used for building user interfaces specifically for single-page applications. It's used for handling the view layer for web and mobile apps. React also allows us to create reusable UI components.<br />
...
Speaking of which, let's start with creating our backend right away.
